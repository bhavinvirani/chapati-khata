...
4. A static host - **Cloudflare Pages**, **Netlify**, **Vercel**, or **GitHub Pages**.
...
Every `git push` redeploys automatically. Share the URL with your group.
...
re-running the deploy - push again, or run it from the **Actions** tab.
...
src/
  ...
  components/
    ...
    AddForm.tsx          # add entry form with date picker
    ToPayCard.tsx        # payment summary
